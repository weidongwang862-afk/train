...
# --- F. 坐标轴美化 ---
ax.set_title("Stepwise Contribution Analysis of Each Module", 
             fontsize=15, fontweight='bold', pad=25, color="#37474F")
ax.set_ylabel("MAE (Test Set)", fontsize=12, labelpad=10, color="#37474F")
...
plt.tight_layout()
plt.show()
fig.savefig("Fig4-6stepwise_contribution.png", dpi=300, facecolor='white', pad_inches=0.1)